...
description: "A retail trader automated his stock screening with a Python script and broker API — replacing a ₹47,000/month advisory service with a free, faster alternative."
date: "2026-04-10"
tags: ["Trading", "Python", "Automation", "Finance"]
image: "/og-default.jpg"
canonicalUrl: "https://architmittal.com/blog/stock-screener-automation-trader-replaced-47k-advisory-python"
---
...
Here's what we built over that weekend. I'm not going to dump code — if you want the technical template, it's in my [GitHub repo](https://github.com/archit-akg13/awesome-business-automation). Instead, let me walk you through the architecture so you understand what's actually happening.
...
| Customisation | Fixed filters, no changes | Fully custom, instant updates |
| Manual screening still needed | Yes (30% filter mismatch) | No |
| Time spent daily | 45 min (reviewing + supplementing) | 0 min (WhatsApp alert) |
...
I've seen the same pattern in [CA firms spending lakhs on seasonal staff](/blog/weekend-python-script-ca-firm-209-hours-itr) to do repetitive ITR data entry. I've seen it in businesses paying for SaaS tools when [a ₹0 stack of free tools](/blog/zero-rupee-automation-stack-enterprise-workflows) does the same job. And I've seen it in the [opposite direction too](/blog/over-automation-trap-when-not-to-automate) — people automating things that should have stayed manual.
