        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="bg-lime hover:bg-lime-dark text-white px-4 py-1.5 rounded-lg text-xs font-heading font-semibold transition-colors"
            >
            ...
            <div className="flex gap-2">
              ...
              <a href="https://x.com/automate_archit" target="_blank" rel="noopener noreferrer" className="text-subtle hover:text-lime transition-colors">
                <SocialIcon name="twitter" className="w-4 h-4" />
              </a>
