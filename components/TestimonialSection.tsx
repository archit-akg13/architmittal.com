export default function TestimonialSection() {
  const testimonials = [
    { quote: 'Archit reduced our AI API costs by 97.5%. What we were spending ₹95K on now costs us ₹10K. The ROI was immediate.', name: 'SaaS Startup Founder', role: 'E-commerce Platform' },
