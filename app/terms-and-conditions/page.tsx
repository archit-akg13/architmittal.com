...
export const metadata: Metadata = {
  ...
  description: 'Terms and Conditions for architmittal.com',
}

export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
      <h1 className="font-heading font-bold text-3xl text-heading mb-8">Terms and Conditions</h1>
      <div className="font-body text-body text-sm leading-relaxed space-y-6">
        ...
        <h2 className="font-heading font-semibold text-lg text-heading pt-4">Eligibility</h2>
        ...
        <h2 className="font-heading font-semibold text-lg text-heading pt-4">Definitions</h2>
        <ul className="list-disc pl-6 space-y-2">
          <li>&ldquo;Payment Instrument&rdquo; includes credit card, debit card, bank account, prepaid payment instrument, Unified Payment Interface (UPI), Immediate Payment Service (IMPS) or any other methods of payments which shall be developed or added or deployed by banks and financial institutions from time to time.</li>
          <li>&ldquo;Platform&rdquo; refers to the website or platform where the Merchant offers its products or services and where the Transaction may be initiated.</li>
          <li>&ldquo;Transaction&rdquo; shall refer to the order or request placed by the User with the Merchant to purchase the products and/or services listed on the Platform by paying the Transaction Amount to the Merchant.</li>
          <li>&ldquo;Transaction Amount&rdquo; shall mean the amount paid by the User in connection with a Transaction.</li>
          <li>&ldquo;User/Users&rdquo; means any person availing the products and/or services offered on the Platform.</li>
          <li>&ldquo;Website&rdquo; shall mean architmittal.com.</li>
        </ul>

        <h2 className="font-heading font-semibold text-lg text-heading pt-4">Merchant&apos;s Rights</h2>
        ...
        <h2 className="font-heading font-semibold text-lg text-heading pt-4">Your Responsibilities</h2>
        ...
        <h2 className="font-heading font-semibold text-lg text-heading pt-4">Prohibited Actions</h2>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>Upload or transmit (or attempt to upload or to transmit) viruses, Trojan horses, or other material that interferes with any party&apos;s uninterrupted use and enjoyment of the Platform or modifies, impairs, disrupts, alters, or interferes with the use, features, functions, operation, or maintenance of the Platform.</li>
        ...
        <h2 className="font-heading font-semibold text-lg text-heading pt-4">Limitation of Liability</h2>
        ...
        <h2 className="font-heading font-semibold text-lg text-heading pt-4">Guidelines for Reviews</h2>
        ...
        <h2 className="font-heading font-semibold text-lg text-heading pt-4">Governing Laws &amp; Dispute Resolution</h2>
        <p>Please note that these terms of use, their subject matter and their formation, are governed by the laws of India. You and we both agree that the courts of India will have exclusive jurisdiction over any dispute. Any dispute or claim arising out of or in connection with or relating to these Terms or their breach, termination or invalidity hereof (&ldquo;Dispute&rdquo;) shall be referred to and finally resolved by arbitration in Bengaluru in accordance with the Arbitration and Conciliation Act, 1996 for the time being in force, which rules are deemed to be incorporated by reference in this clause. Within 30 (thirty) days of the issue of a notice of Dispute, the parties shall mutually agree on the appointment of a sole arbitrator. If such mutual agreement is not arrived at within the aforesaid 30 (thirty) days&apos; period, the parties shall appoint such sole arbitrator in accordance with the Arbitration and Conciliation Act, 1996. The seat of arbitration shall be India and the arbitration proceedings shall be conducted in the English language. The parties shall keep the arbitration confidential and not disclose to any person, other than those necessary to the proceedings, any information, transcripts or award unless required to do so by law. The decision of the arbitrator shall be final and binding on all the parties hereto. The cost of arbitration shall be borne in the manner and by a party as determined by the arbitrators.</p>

        <h2 className="font-heading font-semibold text-lg text-heading pt-4">Grievance Redressal</h2>
        <p>You agree that if you have any question or complaint with regard to any product and/or service availed on our Platform, or pertaining to the Transaction, including but not limited to, double debit of Transaction Amount, fraudulent Transaction, unauthorized Transaction, refund requests, etc., you may reach out to us at <a href="mailto:archit.akg13@gmail.com" className="text-lime hover:underline">archit.akg13@gmail.com</a>.</p>

        <h2 className="font-heading font-semibold text-lg text-heading pt-4">Disclaimer</h2>
        <p>That upon initiating a Transaction, you as a User are entering into a legally binding and enforceable contract with us to purchase the products and/or services, and you shall pay the price as listed on the Platform through legitimate and legal sources of funds and through the accepted Payment Instruments. That you shall provide accurate payment details to the secure payment system for making purchase on the Platform. The information provided by you may be utilized or shared with any third party if required in relation to fraud verifications or by law, regulation or court order. We expressly disclaim all liabilities that may arise as a consequence of any unauthorized use of a User&apos;s Payment Instrument.</p>
        <p>That all payments undertaken by you are subject to your own risk and volition. We shall not be liable for any loss or damage occurred to you arising directly or indirectly due to the decline of authorization for any Transaction, malfunction, errors and/or unscrupulous activities.</p>
        <p>If you receive a User identification code, order ID, password or any other piece of information as part of our security procedures, you must treat such information as confidential. You must not disclose it to any third party.</p>
        <p>The content on our Platform is provided for general information only. The information provided does not amount to advice from us in any manner and should not be relied upon. Where our Platform contains links to other websites and resources provided by third parties, these links are provided for your information only. Such links should not be interpreted as approval by us of those linked websites or information you may obtain from them.</p>
        <p>We do not guarantee that our Platform will be secure or free from bugs or viruses. You are responsible for configuring your information technology, computer programs and platform to access our Platform. You must use your own virus protection software.</p>
      </div>
    </div>
  )
}
